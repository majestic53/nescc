...
namespace nescc {
	...
	namespace tool {
		...
		enum {
			...
			NESCC_TOOL_ASSEMBLER_EXCEPTION_EXPECTING_OPERAND,
		...
		static const std::string NESCC_TOOL_ASSEMBLER_EXCEPTION_STR[] = {
			...
			NESCC_TOOL_ASSEMBLER_EXCEPTION_HEADER "Expecting command statement",
			NESCC_TOOL_ASSEMBLER_EXCEPTION_HEADER "Expecting expression",
			NESCC_TOOL_ASSEMBLER_EXCEPTION_HEADER "Expecting label statement",
			NESCC_TOOL_ASSEMBLER_EXCEPTION_HEADER "Expecting modifier",
			NESCC_TOOL_ASSEMBLER_EXCEPTION_HEADER "Expecting unary modifier",
			NESCC_TOOL_ASSEMBLER_EXCEPTION_HEADER "Expecting operand",
			NESCC_TOOL_ASSEMBLER_EXCEPTION_HEADER "Expecting pragma statement",
			...
			NESCC_TOOL_ASSEMBLER_EXCEPTION_HEADER "Unsupported command statement",
			NESCC_TOOL_ASSEMBLER_EXCEPTION_HEADER "Unsupported pragma statement",
			NESCC_TOOL_ASSEMBLER_EXCEPTION_HEADER "Unsupported conditional pragma statement",
			NESCC_TOOL_ASSEMBLER_EXCEPTION_HEADER "Unsupported data pragma statement",
			NESCC_TOOL_ASSEMBLER_EXCEPTION_HEADER "Unsupported define pragma statement",
			NESCC_TOOL_ASSEMBLER_EXCEPTION_HEADER "Unsupported ines pragma statement",
			};
