...
#ifndef NESCC_TOOL_EMULATOR_TYPE_H_
#define NESCC_TOOL_EMULATOR_TYPE_H_
...
namespace nescc {
	...
	namespace tool {
		...
		#define NESCC_TOOL_EMULATOR_HEADER "[NESCC::TOOL::EMULATOR]"
#ifndef NDEBUG
		#define NESCC_TOOL_EMULATOR_EXCEPTION_HEADER NESCC_TOOL_EMULATOR_HEADER " "
#else
		#define NESCC_TOOL_EMULATOR_EXCEPTION_HEADER
#endif // NDEBUG

		enum {
			NESCC_TOOL_EMULATOR_EXCEPTION_ARGUMENT_MALFORMED = 0,
			NESCC_TOOL_EMULATOR_EXCEPTION_ARGUMENT_MISSING,
			NESCC_TOOL_EMULATOR_EXCEPTION_ARGUMENT_UNSUPPORTED,
			NESCC_TOOL_EMULATOR_EXCEPTION_PATH_REASSIGNED,
			NESCC_TOOL_EMULATOR_EXCEPTION_PATH_UNASSIGNED,
			NESCC_TOOL_EMULATOR_EXCEPTION_UNINITIALIZED,
		};

		#define NESCC_TOOL_EMULATOR_EXCEPTION_MAX NESCC_TOOL_EMULATOR_EXCEPTION_UNINITIALIZED

		static const std::string NESCC_TOOL_EMULATOR_EXCEPTION_STR[] = {
			NESCC_TOOL_EMULATOR_EXCEPTION_HEADER "Malformed argument",
			NESCC_TOOL_EMULATOR_EXCEPTION_HEADER "Missing argument",
			NESCC_TOOL_EMULATOR_EXCEPTION_HEADER "Unsupported argument",
			NESCC_TOOL_EMULATOR_EXCEPTION_HEADER "Path reassigned",
			NESCC_TOOL_EMULATOR_EXCEPTION_HEADER "Path unassigned",
			NESCC_TOOL_EMULATOR_EXCEPTION_HEADER "Emulator is uninitialized",
			};

		#define NESCC_TOOL_EMULATOR_EXCEPTION_STRING(_TYPE_) \
			(((_TYPE_) > NESCC_TOOL_EMULATOR_EXCEPTION_MAX) ? EXCEPTION_UNKNOWN : \
				STRING_CHECK(NESCC_TOOL_EMULATOR_EXCEPTION_STR[_TYPE_]))

		#define THROW_NESCC_TOOL_EMULATOR_EXCEPTION(_EXCEPT_) \
			THROW_NESCC_TOOL_EMULATOR_EXCEPTION_FORMAT(_EXCEPT_, "", "")
		#define THROW_NESCC_TOOL_EMULATOR_EXCEPTION_FORMAT(_EXCEPT_, _FORMAT_, ...) \
			THROW_EXCEPTION_FORMAT(NESCC_TOOL_EMULATOR_EXCEPTION_STRING(_EXCEPT_), \
				_FORMAT_, __VA_ARGS__)

		#define NESCC_EMULATOR "Nescc-emulator"

		#define ARGUMENT_CLEAR "clear"
		#define ARGUMENT_COLUMN_WIDTH 16
		#define ARGUMENT_COLUMN_WIDTH_SUB 82
		...
		enum {
			...
			ARGUMENT_INTERACTIVE_SUBCOMMAND_HALT,
		...
		static const std::string ARGUMENT_INTERACTIVE_SUBCOMMAND_STR_DESC[] = {
			"Enable/Disable CRT filter", // crt
			"Display current cycle count", // cycle
			"Display instructions", // dasm
			"Display current dot", // dot
			"Display memory value", // get
			"Set/Clear halt value", // halt
			...
			"Refresh display window", // present
			"Display/Set register value", // reg
			"Signal reset", // reset
			"Display current scanline", // scanline
			"Set memory value", // set
			"Show display window", // show
			"Display status information", // status
			"Set/Clear strobe", // strobe
			"Set/Clear watched memory addresses", // watch
			};
		...
		static const std::map<uint32_t, std::vector<uint32_t>> ARGUMENT_INTERACTIVE_SUB_MAP = {
			...
			std::make_pair(ARGUMENT_INTERACTIVE_CPU, std::vector<uint32_t>({ ARGUMENT_INTERACTIVE_SUBCOMMAND_CYCLE,
				...
				ARGUMENT_INTERACTIVE_SUBCOMMAND_HALT, ARGUMENT_INTERACTIVE_SUBCOMMAND_HELP,
				ARGUMENT_INTERACTIVE_SUBCOMMAND_IRQ, ARGUMENT_INTERACTIVE_SUBCOMMAND_NEXT,
		...
		static const uint8_t ARGUMENT_INTERACTIVE_SUBCOMMAND_HALT_SUPPORT[] = {
			ARGUMENT_INTERACTIVE_CPU,
			};
		...
		static const std::map<std::string, std::pair<uint32_t, std::set<uint32_t>>> ARGUMENT_INTERACTIVE_SUBCOMMAND_MAP = {
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_CRT), // crt
			...
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_CYCLE), // cycle
			...
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_DISASSEMBLE), // dasm
				std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_DISASSEMBLE, std::set<uint32_t>(
					ARGUMENT_INTERACTIVE_SUBCOMMAND_DISASSEMBLE_SUPPORT, ARGUMENT_INTERACTIVE_SUBCOMMAND_DISASSEMBLE_SUPPORT
						+ sizeof(ARGUMENT_INTERACTIVE_SUBCOMMAND_DISASSEMBLE_SUPPORT)))),
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_DOT), // dot
			...
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_GET), // get
			...
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_HALT), // halt
				std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_HALT, std::set<uint32_t>(
					ARGUMENT_INTERACTIVE_SUBCOMMAND_HALT_SUPPORT, ARGUMENT_INTERACTIVE_SUBCOMMAND_HALT_SUPPORT
						+ sizeof(ARGUMENT_INTERACTIVE_SUBCOMMAND_HALT_SUPPORT)))),
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_HELP), // help
			...
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_HIDE), // hide
			...
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_IRQ), // irq
			...
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_NMI), // nmi
			...
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_PORT), // port
			...
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_PRESENT), // present
			...
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_REGISTER), // reg
			...
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_RESET), // reset
			...
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_SCANLINE), // scanline
			...
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_SET), // set
			...
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_SHOW), // show
			...
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_STATUS), // status
			...
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_STROBE), // strobe
			...
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_WATCH), // watch
...
#endif // NESCC_TOOL_EMULATOR_TYPE_H_
