...
namespace nescc {
	...
	namespace tool {
		...
		static const std::map<std::string, std::pair<uint32_t, std::set<uint32_t>>> ARGUMENT_INTERACTIVE_SUBCOMMAND_MAP = {
			...
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_DISASSEMBLE),
			...
			std::make_pair(ARGUMENT_INTERACTIVE_SUBCOMMAND_STRING(ARGUMENT_INTERACTIVE_SUBCOMMAND_HALT),
