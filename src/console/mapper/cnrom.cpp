...
#include "../../../include/console/mapper/cnrom.h"
	...
	namespace console {
		...
		namespace mapper {
				...
				)
			{
				...
				switch(address) {
					...
					case MAPPER_PROGRAM_1_LOW ... MAPPER_PROGRAM_1_HIGH: // 0x4000 - 0x7fff
						...
						break;
					default:
						THROW_NESCC_CONSOLE_MAPPER_CNROM_EXCEPTION_FORMAT(
							NESCC_CONSOLE_MAPPER_CNROM_EXCEPTION_UNSUPPORTED_ADDRESS,
				...
				) const
			{
				...
				result << NESCC_CONSOLE_MAPPER_CNROM_HEADER << "(" << SCALAR_AS_HEX(uintptr_t, this) << ")";
