...
#ifndef NESCC_CONSOLE_MAPPER_SXROM_TYPE_H_
#define NESCC_CONSOLE_MAPPER_SXROM_TYPE_H_
...
namespace nescc {
	...
	namespace console {
		...
		namespace mapper {
			...
			#define NESCC_CONSOLE_MAPPER_SXROM_HEADER "[NESCC::CONSOLE::MAPPER::SXROM]"
#ifndef NDEBUG
			#define NESCC_CONSOLE_MAPPER_SXROM_EXCEPTION_HEADER NESCC_CONSOLE_MAPPER_SXROM_HEADER " "
#else
			#define NESCC_CONSOLE_MAPPER_SXROM_EXCEPTION_HEADER
#endif // NDEBUG

			enum {
				NESCC_CONSOLE_MAPPER_SXROM_EXCEPTION_UNSUPPORTED_ADDRESS = 0,
			};

			#define NESCC_CONSOLE_MAPPER_SXROM_EXCEPTION_MAX NESCC_CONSOLE_MAPPER_SXROM_EXCEPTION_UNSUPPORTED_ADDRESS

			static const std::string NESCC_CONSOLE_MAPPER_SXROM_EXCEPTION_STR[] = {
				NESCC_CONSOLE_MAPPER_SXROM_EXCEPTION_HEADER "Unsupported mapper address",
				};

			#define NESCC_CONSOLE_MAPPER_SXROM_EXCEPTION_STRING(_TYPE_) \
				(((_TYPE_) > NESCC_CONSOLE_MAPPER_SXROM_EXCEPTION_MAX) ? EXCEPTION_UNKNOWN : \
					STRING_CHECK(NESCC_CONSOLE_MAPPER_SXROM_EXCEPTION_STR[_TYPE_]))

			#define THROW_NESCC_CONSOLE_MAPPER_SXROM_EXCEPTION(_EXCEPT_) \
				THROW_NESCC_CONSOLE_MAPPER_SXROM_EXCEPTION_FORMAT(_EXCEPT_, "", "")
			#define THROW_NESCC_CONSOLE_MAPPER_SXROM_EXCEPTION_FORMAT(_EXCEPT_, _FORMAT_, ...) \
				THROW_EXCEPTION_FORMAT(NESCC_CONSOLE_MAPPER_SXROM_EXCEPTION_STRING(_EXCEPT_), \
...
#endif // NESCC_CONSOLE_MAPPER_SXROM_TYPE_H_
