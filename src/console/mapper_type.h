...
namespace nescc {
	...
	namespace console {
		...
		enum {
			...
			NESCC_CONSOLE_MAPPER_EXCEPTION_UNSUPPORTED,
		};

		#define NESCC_CONSOLE_MAPPER_EXCEPTION_MAX NESCC_CONSOLE_MAPPER_EXCEPTION_UNSUPPORTED

		static const std::string NESCC_CONSOLE_MAPPER_EXCEPTION_STR[] = {
			NESCC_CONSOLE_MAPPER_EXCEPTION_HEADER "Mapper is uninitialized",
			NESCC_CONSOLE_MAPPER_EXCEPTION_HEADER "Unsupported mapper",
			};
