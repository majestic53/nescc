...
#ifndef NESCC_EMULATOR_CPU_TYPE_H_
#define NESCC_EMULATOR_CPU_TYPE_H_
...
namespace nescc {
	...
	namespace emulator {
		...
		#define NESCC_EMULATOR_CPU_HEADER "[NESCC::EMULATOR::CPU]"
#ifndef NDEBUG
		#define NESCC_EMULATOR_CPU_EXCEPTION_HEADER NESCC_EMULATOR_CPU_HEADER " "
#else
		#define NESCC_EMULATOR_CPU_EXCEPTION_HEADER
#endif // NDEBUG

		enum {
			NESCC_EMULATOR_CPU_EXCEPTION_UNINITIALIZED = 0,
			NESCC_EMULATOR_CPU_EXCEPTION_UNSUPPORTED_BRANCH,
			NESCC_EMULATOR_CPU_EXCEPTION_UNSUPPORTED_COMMAND,
			NESCC_EMULATOR_CPU_EXCEPTION_UNSUPPORTED_COMPARE,
			NESCC_EMULATOR_CPU_EXCEPTION_UNSUPPORTED_DECREMENT,
			NESCC_EMULATOR_CPU_EXCEPTION_UNSUPPORTED_FLAG,
			NESCC_EMULATOR_CPU_EXCEPTION_UNSUPPORTED_INCREMENT,
			NESCC_EMULATOR_CPU_EXCEPTION_UNSUPPORTED_LOAD,
			NESCC_EMULATOR_CPU_EXCEPTION_UNSUPPORTED_MODE,
			NESCC_EMULATOR_CPU_EXCEPTION_UNSUPPORTED_NOP,
			NESCC_EMULATOR_CPU_EXCEPTION_UNSUPPORTED_STACK_PULL,
			NESCC_EMULATOR_CPU_EXCEPTION_UNSUPPORTED_STACK_PUSH,
			NESCC_EMULATOR_CPU_EXCEPTION_UNSUPPORTED_STORE,
			NESCC_EMULATOR_CPU_EXCEPTION_UNSUPPORTED_TRANSFER,
		};

		#define NESCC_EMULATOR_CPU_EXCEPTION_MAX NESCC_EMULATOR_CPU_EXCEPTION_UNSUPPORTED_TRANSFER

		static const std::string NESCC_EMULATOR_CPU_EXCEPTION_STR[] = {
			NESCC_EMULATOR_CPU_EXCEPTION_HEADER "Cpu is uninitialized",
			NESCC_EMULATOR_CPU_EXCEPTION_HEADER "Unsupported cpu branch command",
			NESCC_EMULATOR_CPU_EXCEPTION_HEADER "Unsupported cpu command",
			NESCC_EMULATOR_CPU_EXCEPTION_HEADER "Unsupported cpu compare command",
			NESCC_EMULATOR_CPU_EXCEPTION_HEADER "Unsupported cpu decrement command",
			NESCC_EMULATOR_CPU_EXCEPTION_HEADER "Unsupported cpu flag command",
			NESCC_EMULATOR_CPU_EXCEPTION_HEADER "Unsupported cpu increment command",
			NESCC_EMULATOR_CPU_EXCEPTION_HEADER "Unsupported cpu load command",
			NESCC_EMULATOR_CPU_EXCEPTION_HEADER "Unsupported cpu address mode",
			NESCC_EMULATOR_CPU_EXCEPTION_HEADER "Unsupported cpu nop command",
			NESCC_EMULATOR_CPU_EXCEPTION_HEADER "Unsupported cpu stack pull command",
			NESCC_EMULATOR_CPU_EXCEPTION_HEADER "Unsupported cpu stack push command",
			NESCC_EMULATOR_CPU_EXCEPTION_HEADER "Unsupported cpu store command",
			NESCC_EMULATOR_CPU_EXCEPTION_HEADER "Unsupported cpu transfer command",
			};

		#define NESCC_EMULATOR_CPU_EXCEPTION_STRING(_TYPE_) \
			(((_TYPE_) > NESCC_EMULATOR_CPU_EXCEPTION_MAX) ? EXCEPTION_UNKNOWN : \
				STRING_CHECK(NESCC_EMULATOR_CPU_EXCEPTION_STR[_TYPE_]))

		#define THROW_NESCC_EMULATOR_CPU_EXCEPTION(_EXCEPT_) \
			THROW_NESCC_EMULATOR_CPU_EXCEPTION_FORMAT(_EXCEPT_, "", "")
		#define THROW_NESCC_EMULATOR_CPU_EXCEPTION_FORMAT(_EXCEPT_, _FORMAT_, ...) \
			THROW_EXCEPTION_FORMAT(NESCC_EMULATOR_CPU_EXCEPTION_STRING(_EXCEPT_), \
...
#endif // NESCC_EMULATOR_CPU_TYPE_H_
