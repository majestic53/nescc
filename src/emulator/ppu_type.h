...
#ifndef NESCC_EMULATOR_PPU_TYPE_H_
#define NESCC_EMULATOR_PPU_TYPE_H_
...
namespace nescc {
	...
	namespace emulator {
		...
		#define NESCC_EMULATOR_PPU_HEADER "[NESCC::EMULATOR::PPU]"
#ifndef NDEBUG
		#define NESCC_EMULATOR_PPU_EXCEPTION_HEADER NESCC_EMULATOR_PPU_HEADER " "
#else
		#define NESCC_EMULATOR_PPU_EXCEPTION_HEADER
#endif // NDEBUG

		enum {
			NESCC_EMULATOR_PPU_EXCEPTION_UNINITIALIZED,
			NESCC_EMULATOR_PPU_EXCEPTION_UNSUPPORTED,
		};

		#define NESCC_EMULATOR_PPU_EXCEPTION_MAX NESCC_EMULATOR_PPU_EXCEPTION_UNSUPPORTED

		static const std::string NESCC_EMULATOR_PPU_EXCEPTION_STR[] = {
			NESCC_EMULATOR_PPU_EXCEPTION_HEADER "Ppu is uninitialized",
			NESCC_EMULATOR_PPU_EXCEPTION_HEADER "Unsupported ppu port",
			};

		#define NESCC_EMULATOR_PPU_EXCEPTION_STRING(_TYPE_) \
			(((_TYPE_) > NESCC_EMULATOR_PPU_EXCEPTION_MAX) ? EXCEPTION_UNKNOWN : \
				STRING_CHECK(NESCC_EMULATOR_PPU_EXCEPTION_STR[_TYPE_]))

		#define THROW_NESCC_EMULATOR_PPU_EXCEPTION(_EXCEPT_) \
			THROW_NESCC_EMULATOR_PPU_EXCEPTION_FORMAT(_EXCEPT_, "", "")
		#define THROW_NESCC_EMULATOR_PPU_EXCEPTION_FORMAT(_EXCEPT_, _FORMAT_, ...) \
			THROW_EXCEPTION_FORMAT(NESCC_EMULATOR_PPU_EXCEPTION_STRING(_EXCEPT_), \
		...
		#define PPU_DOT_MMU_INTERRUPT 260
...
#endif // NESCC_EMULATOR_PPU_TYPE_H_
