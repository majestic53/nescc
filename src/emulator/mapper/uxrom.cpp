...
#include "../../../include/emulator/mapper/uxrom.h"
	...
	namespace emulator {
		...
		namespace mapper {
				...
				)
			{
				...
				switch(address) {
					...
					case MAPPER_PROGRAM_1_LOW ... MAPPER_PROGRAM_1_HIGH: // 0x4000 - 0x7fff
						...
						break;
					default:
						THROW_NESCC_EMULATOR_MAPPER_UXROM_EXCEPTION_FORMAT(
							NESCC_EMULATOR_MAPPER_UXROM_EXCEPTION_UNSUPPORTED_ADDRESS,
				...
				) const
			{
				...
				result << NESCC_EMULATOR_MAPPER_UXROM_HEADER << "(" << SCALAR_AS_HEX(uintptr_t, this) << ")";
