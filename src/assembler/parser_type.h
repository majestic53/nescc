...
namespace nescc {
	...
	namespace assembler {
		...
		static const std::string NESCC_ASSEMBLER_PARSER_EXCEPTION_STR[] = {
			...
			NESCC_ASSEMBLER_PARSER_EXCEPTION_HEADER "Expecting block",
			...
			NESCC_ASSEMBLER_PARSER_EXCEPTION_HEADER "Unterminated block",
			...
			NESCC_ASSEMBLER_PARSER_EXCEPTION_HEADER "Unterminated include",
