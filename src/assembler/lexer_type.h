...
namespace nescc {
	...
	namespace assembler {
		...
		enum {
			...
			NESCC_ASSEMBLER_LEXER_EXCEPTION_EMPTY_INCLUDE_FILE,
			NESCC_ASSEMBLER_LEXER_EXCEPTION_EMPTY_INCLUDE_PATH,
			...
			NESCC_ASSEMBLER_LEXER_EXCEPTION_EXPECTING_INCLUDE_PATH,
			NESCC_ASSEMBLER_LEXER_EXCEPTION_EXPECTING_SYMBOL,
			NESCC_ASSEMBLER_LEXER_EXCEPTION_INCLUDE_NOT_FOUND,
			NESCC_ASSEMBLER_LEXER_EXCEPTION_MALFORMED_INCLUDE_FILE,
			NESCC_ASSEMBLER_LEXER_EXCEPTION_MALFORMED_INCLUDE_PATH,
		...
		static const std::string NESCC_ASSEMBLER_LEXER_EXCEPTION_STR[] = {
			...
			NESCC_ASSEMBLER_LEXER_EXCEPTION_HEADER "Empty include file",
			NESCC_ASSEMBLER_LEXER_EXCEPTION_HEADER "Empty include path",
			...
			NESCC_ASSEMBLER_LEXER_EXCEPTION_HEADER "Expecting include path",
			NESCC_ASSEMBLER_LEXER_EXCEPTION_HEADER "Expecting symbol",
			NESCC_ASSEMBLER_LEXER_EXCEPTION_HEADER "Include file does not exist",
			NESCC_ASSEMBLER_LEXER_EXCEPTION_HEADER "Malformed include file",
			NESCC_ASSEMBLER_LEXER_EXCEPTION_HEADER "Malformed include path",
