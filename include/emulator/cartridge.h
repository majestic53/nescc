...
#ifndef NESCC_EMULATOR_CARTRIDGE_H_
#define NESCC_EMULATOR_CARTRIDGE_H_
...
namespace nescc {
	...
	namespace emulator {
		...
		#define CARTRIDGE_RAM_PROGRAM_LENGTH 0x2000 // 8 KB
		#define CARTRIDGE_RAM_PROGRAM_MAX (CARTRIDGE_RAM_PROGRAM_LENGTH - 1)
		#define CARTRIDGE_ROM_CHARACTER_LENGTH 0x2000 // 8 KB
		#define CARTRIDGE_ROM_CHARACTER_MAX (CARTRIDGE_ROM_CHARACTER_LENGTH - 1)
		#define CARTRIDGE_ROM_PROGRAM_LENGTH 0x4000 // 16 KB
		...
		#define CARTRIDGE_MAPPER_MAX nescc::emulator::CARTRIDGE_MAPPER_AXROM
		...
		#define CARTRIDGE_MAPPER_STRING(_TYPE_) \
			(((_TYPE_) > CARTRIDGE_MAPPER_MAX) ? STRING_UNKNOWN : \
				STRING_CHECK(nescc::emulator::CARTRIDGE_MAPPER_STR[_TYPE_]))
		...
		#define CARTRIDGE_RAM_PROGRAM_WIDTH(_TYPE_) \
			(((_TYPE_) > CARTRIDGE_MAPPER_MAX) ? nescc::emulator::CARTRIDGE_RAM_PROGRAM_WID[0] : \
				nescc::emulator::CARTRIDGE_RAM_PROGRAM_WID[_TYPE_])
		...
		#define CARTRIDGE_ROM_CHARACTER_WIDTH(_TYPE_) \
			(((_TYPE_) > CARTRIDGE_MAPPER_MAX) ? nescc::emulator::CARTRIDGE_ROM_CHARACTER_WID[0] : \
				nescc::emulator::CARTRIDGE_ROM_CHARACTER_WID[_TYPE_])
		...
		#define CARTRIDGE_ROM_PROGRAM_WIDTH(_TYPE_) \
			(((_TYPE_) > CARTRIDGE_MAPPER_MAX) ? nescc::emulator::CARTRIDGE_ROM_PROGRAM_WID[0] : \
				nescc::emulator::CARTRIDGE_ROM_PROGRAM_WID[_TYPE_])
		...
		#define CARTRIDGE_MIRRORING_MAX nescc::emulator::CARTRIDGE_MIRRORING_VERTICAL
		...
		#define CARTRIDGE_MIRRORING_STRING(_TYPE_) \
			(((_TYPE_) > CARTRIDGE_MIRRORING_MAX) ? STRING_UNKNOWN : \
				STRING_CHECK(nescc::emulator::CARTRIDGE_MIRRORING_STR[_TYPE_]))
		...
		#define CARTRIDGE_TV_SYSTEM_MAX nescc::emulator::CARTRIDGE_TV_SYSTEM_PAL
		...
		#define CARTRIDGE_TV_SYSTEM_STRING(_TYPE_) \
			(((_TYPE_) > CARTRIDGE_TV_SYSTEM_MAX) ? STRING_UNKNOWN : \
				STRING_CHECK(nescc::emulator::CARTRIDGE_TV_SYSTEM_STR[_TYPE_]))
		...
		class cartridge :
				public nescc::core::singleton<nescc::emulator::cartridge> {
			...
			protected:
				...
				friend class nescc::core::singleton<nescc::emulator::cartridge>;
...
#endif // NESCC_EMULATOR_CARTRIDGE_H_
