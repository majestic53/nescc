...
#ifndef NESCC_EMULATOR_CPU_H_
#define NESCC_EMULATOR_CPU_H_
...
namespace nescc {
	...
	namespace emulator {
		...
		class cpu :
				public nescc::core::singleton<nescc::emulator::cpu> {
			...
			protected:
				...
				friend class nescc::core::singleton<nescc::emulator::cpu>;
