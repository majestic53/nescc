...
#ifndef NESCC_EMULATOR_JOYPAD_H_
#define NESCC_EMULATOR_JOYPAD_H_
...
namespace nescc {
	...
	namespace emulator {
		...
		class joypad :
				public nescc::core::singleton<nescc::emulator::joypad> {
			...
			protected:
				...
				friend class nescc::core::singleton<nescc::emulator::joypad>;
...
#endif // NESCC_EMULATOR_JOYPAD_H_
