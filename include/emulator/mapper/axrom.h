...
#ifndef NESCC_EMULATOR_MAPPER_AXROM_H_
#define NESCC_EMULATOR_MAPPER_AXROM_H_
...
namespace nescc {
	...
	namespace emulator {
		...
		namespace mapper {
			...
			union port_axrom_bank_select_t {
				struct {
					uint8_t select : 3;
					uint8_t unused_0 : 1;
					uint8_t select_vram : 1;
					uint8_t unused_1 : 3;
				};
				uint8_t raw;
			};
			...
			class axrom :
				...
				protected:
					...
					nescc::emulator::mapper::port_axrom_bank_select_t m_port_select;
...
#endif // NESCC_EMULATOR_MAPPER_AXROM_H_
