...
#ifndef NESCC_CONSOLE_MAPPER_SXROM_H_
#define NESCC_CONSOLE_MAPPER_SXROM_H_
		...
		namespace mapper {
			...
			class sxrom :
				...
				protected:
					...
					std::vector<nescc::console::mapper::port_sxrom_bank_character_t> m_port_bank_character;

					nescc::console::mapper::port_sxrom_bank_program_t m_port_bank_program;

					nescc::console::mapper::port_sxrom_control_t m_port_control;

					nescc::console::mapper::port_sxrom_load_t m_port_load;
...
#endif // NESCC_CONSOLE_MAPPER_SXROM_H_
