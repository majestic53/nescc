...
#ifndef NESCC_CONSOLE_MAPPER_UXROM_H_
#define NESCC_CONSOLE_MAPPER_UXROM_H_
		...
		namespace mapper {
			...
			class uxrom :
				...
				protected:
					...
					nescc::console::mapper::port_uxrom_bank_select_t m_port_select;
...
#endif // NESCC_CONSOLE_MAPPER_UXROM_H_
