...
#ifndef NESCC_CONSOLE_MAPPER_AXROM_H_
#define NESCC_CONSOLE_MAPPER_AXROM_H_
		...
		namespace mapper {
			...
			class axrom :
				...
				protected:
					...
					nescc::console::mapper::port_axrom_bank_select_t m_port_select;
...
#endif // NESCC_CONSOLE_MAPPER_AXROM_H_
